          ...
          <div className="bg-slate-900/80 rounded-2xl border border-slate-800 p-5 sm:p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
              ...
              <div className="p-3 sm:p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
                ...
                <div className="text-xs text-slate-400 mt-0.5">Distribuição diária</div>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {dietPlan.meals.map((meal) => (
                  ...
                  >
                          ...
                          meal.items.map((item) => (
                            ...
                            >
                              <div>
                                ...
                                <span className="text-slate-400 block text-xs">{item.portion}</span>
                              </div>
                    ...
                    {/* Resumo da Refeição */}
                    <div className="pt-2 mt-2 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-400">
      ...
      {isPlanModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150 shadow-2xl">
            ...
            <form onSubmit={handleSavePlan} className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
              <div>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150 shadow-2xl">
            <div className="flex items-center justify-between p-4 sm:p-5 border-b border-slate-800 flex-shrink-0">
              ...
              <button onClick={() => setIsMealModalOpen(false)} className="text-slate-400 hover:text-white p-1 rounded-lg">
                <X className="w-4 h-4" />
              </button>
            </div>

            <form onSubmit={handleSaveMeal} className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
              ...
              <div className="p-3.5 bg-slate-950/70 rounded-xl border border-slate-800 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-amber-400 font-bold text-xs rounded-lg transition-colors border border-slate-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                  >
                    <Plus className="w-3.5 h-3.5" />
                    <span>Incluir</span>
                  </button>
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-slate-800">
                    {mealItems.map((it) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          {it.calories && <span className="text-amber-400/90 text-xs">{it.calories} kcal</span>}
                          <button
                            type="button"
